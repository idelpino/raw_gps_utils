...
{
    private:
        rawgpsutils::ScalarT time_stamp_; ///< Time stamp. Expressed in seconds from 1th jan 1970.
    ...
    public:
         ...
         *
         */
        TimeStamp(const rawgpsutils::ScalarT _ts);
         ...
         *
         */
        void set(const rawgpsutils::ScalarT ts);
         ...
         * 
         */
        void operator=(const rawgpsutils::ScalarT & ts);
         ...
         * 
         */
        rawgpsutils::ScalarT operator-(const TimeStamp & ts) const;
