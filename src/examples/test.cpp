...
int main(int argc, char** argv)
{
    ...
    NavData nav("ciao NAV", TimeStamp(42), rawgpsutils::ScalarT(100000), rawgpsutils::ScalarT(654654), rawgpsutils::ScalarT(456456));
    ...
    ObsData obs(name, TimeStamp(43), rawgpsutils::ScalarT(100000));
